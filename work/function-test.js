...
assert(indexHtml.includes("app.js?v=0.73"), "script should use cache-busting version");
assert(indexHtml.includes("supabase-config.js?v=0.73"), "Supabase config should be loaded before the app");
...
assert(indexHtml.includes("v0.73"), "app shell should expose the new version");
...
assert(indexHtml.includes("privacy-guard.js?v=0.73"), "privacy guard should be cache-busted");
assert(serviceWorker.includes("privacy-guard.js?v=0.73"), "privacy guard should be cached with the app shell");
...
assert(manifest.start_url.includes("v=0.73"), "manifest start URL should be cache-busted");
...
assert(manifest.icons.every((icon) => icon.src.includes("v=0.73")), "manifest icons should be cache-busted");
assert(indexHtml.includes("app-icon-180.png?v=0.73"), "iOS touch icon should use PNG");
assert(indexHtml.includes("health-dashboard-favicon.ico?v=0.73"), "browser favicon should use a unique Health Dashboard ICO filename");
assert(indexHtml.includes("health-dashboard-favicon-32.png?v=0.73"), "browser favicon should use a unique 32px PNG filename");
assert(indexHtml.includes("health-dashboard-favicon-16.png?v=0.73"), "browser favicon should use a unique 16px PNG filename");
...
assert(serviceWorker.includes("health-dashboard-v0.73"), "service worker cache should match app version");
assert(serviceWorker.includes("app.js?v=0.73"), "service worker should cache current app bundle");
assert(serviceWorker.includes("supabase-config.js?v=0.73"), "service worker should cache Supabase config placeholder");
assert(serviceWorker.includes("health-dashboard-favicon.ico?v=0.73"), "service worker should cache the unique ICO favicon");
assert(serviceWorker.includes("health-dashboard-favicon-32.png?v=0.73"), "service worker should cache the unique PNG favicon");
assert(serviceWorker.includes("app-icon-512.png?v=0.73"), "service worker should cache PNG app icons");
...
assert(document.elements.appVersion.textContent === "v0.73", "footer should show app version");
...
context.window.location.href = "https://benashy.github.io/health-tracker/index.html?v=0.73";
...
assert(context.getVitaminItems("ben").some((item) => item.item === "Daily Essentials"), "Ben should have Daily Essentials in the vitamin organiser");
assert(context.getVitaminItems("ben").some((item) => item.item === "Daily Longevity"), "Ben should have Daily Longevity in the vitamin organiser");
assert(context.getVitaminItems("ben").find((item) => item.item === "Daily Essentials").timing === "Breakfast", "Daily Essentials should sit with breakfast after fexofenadine");
assert(context.getVitaminItems("ben").find((item) => item.item === "Daily Longevity").timing === "Breakfast", "Daily Longevity should sit with breakfast after fexofenadine");
...
assert(!context.getVitaminItems("ben").some((item) => item.item.includes("IM8")), "IM8 brand name should stay hidden from the organiser labels");
...
assert(document.elements.vitaminsMainBody.innerHTML.includes("Daily Essentials"), "Vitamins organiser should render Daily Essentials");
assert(document.elements.vitaminsMainBody.innerHTML.includes("Daily Longevity"), "Vitamins organiser should render Daily Longevity");
...
assert(document.elements.vitaminsTodayList.innerHTML.includes("Daily Essentials"), "Today view should include Daily Essentials");
assert(document.elements.vitaminsTodayList.innerHTML.includes("Daily Longevity"), "Today view should include Daily Longevity");
assert(document.elements.vitaminsTodayList.innerHTML.indexOf("Fexofenadine") < document.elements.vitaminsTodayList.innerHTML.indexOf("Daily Essentials"), "Today view should show fexofenadine before breakfast IM8 items");
...
context.showVitaminDoseFeedback("Fexofenadine: 1 tablet");
assert(document.elements.vitaminsDoseFeedback.textContent === "Fexofenadine: 1 tablet", "clicking a vitamin should show its dosage");
